...
<template>
    <!-- a été enlevé dans les conditions de panel v-if="klipperReadyForGui"-->
    <panel
...
export default class GraphicPanel extends Mixins(BaseMixin) {
