    ...
    <v-container fluid py-0 px-0>
        <v-row>
            <v-col class="col-12 col-md-6 pb-0 pb-md-3">
                <pumpacros-panel></pumpacros-panel>
                <div> Aucun changement apporté </div>
            </v-col>
...
import GraphicPanel from '@/components/panels/Display/GraphicPanel.vue'
import PumpacrosPanel from '@/components/panels/Maintenance/PumpMacrosPanel.vue'
@Component({
    components: {
        SystemPanel,
        ConfigFilesPanel,
...
export default class PageMaintenance extends Mixins(BaseMixin) {
